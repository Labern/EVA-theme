...
# How to use
# PROMPT and RPROMPT
# Colour: %{$fg[colour]%} thing to print
# $fg_no_bold and $fg_bold
# %n = user
# %~ = working directory
# %m = computer

# So, to print user name in bold:
# %{$fg_bold[blue]%}%n}


# PROMPT='%{$fg_no_bold[green]%}%n%{$fg_no_bold[magenta]%}-UNIT01%{$fg_no_bold[green]%}> 
# %{$fg_no_bold[blue]%} PROJECT EVA•: %}
# %{$fg_no_bold[yellow]%}%3~ 
# $(git_prompt_info)%{$fg_no_bold[red]%}✝ ● ヨ: '
